...
--
-- Host: 127.0.0.1
-- Tempo de geração: 31/01/2025 às 20:11
...
INSERT INTO `feedbacks` (`feedback_id`, `comentario`, `data_hora`) VALUES
(1, 'Muito legal', '2025-01-31 22:33:40');
...
('root', '[{\"db\":\"feedback_clientes\",\"table\":\"feedbacks\"},{\"db\":\"feedback_clientes\",\"table\":\"clientes\"},{\"db\":\"agenda_consultas\",\"table\":\"consultas\"},{\"db\":\"agenda_consultas\",\"table\":\"medicos\"},{\"db\":\"agenda_consultas\",\"table\":\"pacientes\"},{\"db\":\"gestao_inventario\",\"table\":\"movimentacoes\"},{\"db\":\"gestao_inventario\",\"table\":\"produtos\"}]');
...
('root', '2025-01-31 19:10:59', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt_BR\"}');
